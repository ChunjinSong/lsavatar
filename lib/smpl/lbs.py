...
def lbs(betas, pose, v_template, shapedirs, posedirs, J_regressor, parents,
    ...
    J_transformed, A, l2w = batch_rigid_transform(rot_mats, J, parents, dtype=dtype)
    ...
    return verts, J_transformed, T, W, A.view(batch_size, num_joints, 4,4), l2w.view(batch_size, num_joints, 4,4)
